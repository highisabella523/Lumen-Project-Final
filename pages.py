...
.ml-preferred-route{display:flex;align-items:center;justify-content:space-between;gap:8px;padding:10px 12px;border-radius:var(--md-sys-shape-corner-medium,12px);background:var(--md-sys-color-primary-container);color:var(--md-sys-color-on-primary-container);font-size:.7rem;font-weight:750}.ml-preferred-route small{font-size:.64rem;font-weight:650;opacity:.86}.psiphon-status{margin:0 18px 18px;padding:16px;border-radius:var(--md-sys-shape-corner-large,16px);background:var(--md-sys-color-surface-container-lowest);border:1px solid var(--md-sys-color-outline-variant)}.psiphon-status-head{display:flex;align-items:flex-start;justify-content:space-between;gap:12px;margin-bottom:12px}.psiphon-status-title{font-size:.78rem;font-weight:800;color:var(--md-sys-color-on-surface)}.psiphon-status-sub{font-size:.67rem;line-height:1.5;color:var(--md-sys-color-on-surface-variant);margin-top:3px}.psiphon-status-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(142px,1fr));gap:8px}.psiphon-status-cell{padding:11px 12px;border-radius:var(--md-sys-shape-corner-medium,12px);background:var(--md-sys-color-surface-container-low)}.psiphon-status-cell span{display:block;font-size:.61rem;font-weight:750;letter-spacing:.04em;text-transform:uppercase;color:var(--md-sys-color-on-surface-variant)}.psiphon-status-cell strong{display:block;margin-top:5px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:.74rem;color:var(--md-sys-color-on-surface)}.psiphon-status-state{display:inline-flex;align-items:center;border-radius:var(--md-sys-shape-corner-full);padding:4px 9px;font-size:.62rem;font-weight:800;background:var(--md-sys-color-surface-container-high);color:var(--md-sys-color-on-surface-variant)}.psiphon-status-state.healthy{background:var(--md-sys-color-primary-container);color:var(--md-sys-color-on-primary-container)}.psiphon-status-state.failed{background:var(--md-sys-color-error-container);color:var(--md-sys-color-on-error-container)}.psiphon-status-note{margin-top:10px;font-size:.67rem;line-height:1.5;color:var(--md-sys-color-on-surface-variant)}@media(max-width:639px){.proxy-performance,.psiphon-status{margin:0 14px 14px}.proxy-performance-head,.psiphon-status-head{align-items:stretch;flex-direction:column}}
...
:root{--orbit:264px}body{display:block!important;font-size:15px!important;background:var(--md-sys-color-surface)!important}.orbit-top{position:fixed;z-index:180;left:calc(var(--orbit) + 40px);right:24px;top:16px;height:68px;padding:0 18px;display:flex;align-items:center;gap:10px;border:1px solid var(--md-sys-color-outline-variant);border-radius:28px;background:color-mix(in srgb,var(--md-sys-color-surface-container-low) 90%,transparent);backdrop-filter:blur(22px)}.orbit-wordmark b,.orbit-wordmark small{display:block}.orbit-wordmark small{color:var(--md-sys-color-on-surface-variant)}.orbit-online{margin-inline-start:auto;display:flex;gap:8px;align-items:center;color:var(--green-t);font-weight:700}.orbit-online i,.orbit-health>b i{width:9px;height:9px;border-radius:50%;background:var(--green);box-shadow:0 0 0 5px color-mix(in srgb,var(--green) 14%,transparent)}.orbit-icon{width:44px;height:44px;border:0;border-radius:999px;background:var(--md-sys-color-secondary-container);color:var(--md-sys-color-on-secondary-container)}#open-sb{display:none}.sidebar{left:16px!important;right:auto!important;top:16px!important;bottom:16px!important;width:var(--orbit)!important;transform:none!important;border-radius:32px 32px 12px 32px!important;background:var(--md-sys-color-surface-container-low)!important;border:1px solid var(--md-sys-color-outline-variant)!important;box-shadow:none!important}.orbit-brand{height:88px;padding:16px;display:flex;align-items:center;gap:12px}.orbit-brand>span{width:48px;height:48px;display:grid;place-items:center;border-radius:18px 18px 6px 18px;background:var(--md-sys-color-primary);color:var(--md-sys-color-on-primary);font-size:22px}.orbit-brand b,.orbit-brand small{display:block}.orbit-brand small{color:var(--md-sys-color-on-surface-variant)}.sb-close{display:none!important;position:static!important;margin-inline-start:auto}.nav-wrap{display:block!important;padding:4px 12px!important}.nav-sec{display:block!important;padding:15px 12px 7px!important}.nav-it{min-height:48px!important;margin:2px 0!important;padding:9px 12px!important;display:flex!important;flex-direction:row!important;justify-content:flex-start!important;gap:11px!important;border-radius:16px!important;font-size:.8rem!important}.nav-it.on{border-radius:22px 22px 7px 22px!important;background:var(--md-sys-color-primary-container)!important}.nav-badge{position:static!important;margin-inline-start:auto!important}.sb-foot{display:grid!important;grid-template-columns:1fr 1fr 48px!important;gap:7px!important}.sb-foot button{grid-column:auto!important;border-radius:16px!important}.sb-foot .logout-btn span{display:none!important}.main{margin:0!important;padding:108px 24px 72px calc(var(--orbit) + 40px)!important}.pg{max-width:1440px!important}.topbar{position:relative!important;top:auto!important;border:0!important;border-bottom:1px solid var(--md-sys-color-outline-variant)!important;border-radius:0!important;background:transparent!important;box-shadow:none!important}.orbit-intro{display:flex;align-items:flex-end;justify-content:space-between;gap:24px;margin:18px 4px 28px}.orbit-intro small,.orbit-health small,.orbit-route label,.orbit-insights small,.orbit-trust>div>small{color:var(--md-sys-color-primary);font-weight:800;letter-spacing:.15em}.orbit-intro h1{font:780 clamp(2.6rem,5vw,4.8rem)/.98 var(--md-ref-typeface-brand);letter-spacing:-.055em;margin:8px 0}.orbit-intro p{color:var(--md-sys-color-on-surface-variant)}.orbit-refresh{min-height:54px;padding:0 20px;border:0;border-radius:20px 20px 7px 20px;background:var(--md-sys-color-primary);color:var(--md-sys-color-on-primary);font-weight:750}.orbit-health{overflow:hidden;border-radius:44px 44px 16px 44px;background:var(--md-sys-color-primary-container);color:var(--md-sys-color-on-primary-container);display:grid;grid-template-columns:112px 1fr auto;gap:28px;align-items:center;padding:34px 38px 0}.orbit-rings{width:108px;height:108px;border:1px solid var(--md-sys-color-primary);border-radius:42% 58% 54% 46%;display:grid;place-items:center;font-size:38px}.orbit-health h2{font:760 clamp(1.6rem,3vw,2.8rem)/1.05 var(--md-ref-typeface-brand);letter-spacing:-.04em;margin:8px 0}.orbit-health>b{display:flex;gap:10px;align-items:center;padding:13px;border-radius:999px;background:color-mix(in srgb,var(--md-sys-color-on-primary-container) 10%,transparent)}.orbit-health footer{grid-column:1/-1;margin:0 -38px;display:grid;grid-template-columns:repeat(3,1fr);background:color-mix(in srgb,var(--md-sys-color-surface) 16%,transparent)}.orbit-health footer span{padding:18px 24px}.orbit-health footer strong{display:block;margin-top:5px}.orbit-health em{display:block;margin-top:8px}.orbit-flow{display:grid;grid-template-columns:1.55fr .45fr;gap:18px;margin-top:18px}.orbit-route{padding:30px;border-radius:36px 36px 36px 12px;background:var(--md-sys-color-surface-container-lowest)}.orbit-route label{display:flex;gap:8px;align-items:center}.orbit-route label b{margin-inline-start:auto;padding:7px 10px;border-radius:999px;background:var(--md-sys-color-secondary-container)}.orbit-route h2{font-size:1.8rem}.orbit-route>code{display:block;padding:17px;border-radius:18px;background:var(--md-sys-color-surface-container);overflow-wrap:anywhere;direction:ltr}.orbit-route>div{display:flex;flex-wrap:wrap;gap:8px;margin-top:16px}.orbit-pulse{display:grid;grid-template-columns:1fr 1fr;gap:1px;overflow:hidden;border-radius:36px 36px 12px 36px;background:var(--md-sys-color-outline-variant)}.orbit-pulse>div{padding:20px;background:var(--md-sys-color-surface-container)}.orbit-pulse>div:first-child{grid-column:1/-1;background:var(--md-sys-color-tertiary-container)}.orbit-pulse strong{display:block;font-size:1.5rem;margin-top:12px}.orbit-pulse>div:first-child strong{font-size:3rem}.orbit-pulse span{color:var(--md-sys-color-on-surface-variant)}.orbit-insights{display:grid;grid-template-columns:2fr 1fr;gap:18px;margin-top:18px}.orbit-insights article{padding:24px;border-radius:36px;background:var(--md-sys-color-surface-container-low)}.orbit-insights article:last-child{border-radius:36px 36px 12px 36px;background:var(--md-sys-color-secondary-container)}.orbit-insights header{display:flex;justify-content:space-between}.orbit-insights header button{border:0;background:transparent;color:var(--md-sys-color-primary)}.orbit-trust{display:grid;grid-template-columns:.65fr 1.2fr;gap:26px;margin-top:18px;padding:28px 30px;border-block:1px solid var(--md-sys-color-outline-variant)}.orbit-trust-list{display:grid;grid-template-columns:1fr 1fr}.orbit-trust-list span{display:grid;grid-template-columns:36px 1fr auto;align-items:center;gap:9px;padding:14px}.orbit-trust-list i{width:36px;height:36px;display:grid;place-items:center;border-radius:13px;background:var(--md-sys-color-primary-container)}.orbit-trust-list b{color:var(--green-t)}.orbit-trust details{grid-column:1/-1;border-top:1px solid var(--md-sys-color-outline-variant);padding-top:12px}.orbit-trust summary{min-height:48px}.orbit-trust summary b{float:inline-end}.psiphon-status{margin:18px!important;padding:0!important;border:0!important;border-radius:30px!important;overflow:hidden;background:var(--md-sys-color-surface-container-lowest)!important}.psiphon-status-head{margin:0!important;padding:22px;display:grid!important;grid-template-columns:1fr minmax(220px,.55fr);gap:20px;background:var(--md-sys-color-surface-container-high)}.psiphon-status-state{min-height:78px!important;padding:14px!important;border-radius:24px!important;display:grid!important;grid-template-columns:44px 1fr!important;align-items:center!important}.psiphon-status-state>i{grid-row:1/3;font-size:24px}.state-degraded,.state-starting,.state-reconnecting,.state-unknown{background:var(--md-sys-color-tertiary-container)!important;color:var(--md-sys-color-on-tertiary-container)!important}.state-failed,.state-unavailable{background:var(--md-sys-color-error-container)!important;color:var(--md-sys-color-on-error-container)!important}.psiphon-status-note{margin:0!important;padding:18px 22px!important;display:flex;gap:12px;background:var(--md-sys-color-primary-container);color:var(--md-sys-color-on-primary-container)!important}.psiphon-status-note div>*{display:block}.psiphon-status-note.has-issue{background:var(--md-sys-color-error-container);color:var(--md-sys-color-on-error-container)!important}.psi-details{padding:16px 20px}.psi-details summary{min-height:48px}.psi-details summary i{float:inline-end}.psi-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:8px}.psi-grid .psiphon-status-cell strong{white-space:normal!important;overflow-wrap:anywhere}.create-panel{display:block!important;border-radius:36px 36px 12px 36px!important}.cp-head{padding:28px 30px!important;border-radius:36px 36px 0 0!important;flex-direction:row!important;background:var(--md-sys-color-secondary-container)!important}.cp-head::after{display:none!important}.cp-head-title{max-width:none!important}.cp-body{display:grid!important;grid-template-columns:repeat(12,1fr)!important}.create-panel .cp-row{display:contents!important}.create-panel .cp-block{grid-column:span 6!important}.create-panel .cp-body>.cp-block:nth-of-type(n+3),.create-panel .endpoint-studio,.create-panel .config-proxy-studio,.create-panel .cp-footer{grid-column:1/-1!important}.cfg-grid{grid-template-columns:1fr!important}.route-card{display:grid!important;grid-template-columns:1fr minmax(310px,.45fr)!important}.route-head,.route-network,.route-data,.route-uuid,.route-proxy{grid-column:1!important}.route-actions{grid-column:2!important;grid-row:1/6!important;align-content:center!important;grid-template-columns:1fr 1fr!important;border-inline-start:1px solid var(--md-sys-color-outline-variant)!important}.route-action.primary,.route-action.secondary{grid-column:1/-1!important}.empty,.empty-v2,#logs-empty,#conns-empty{border:1px dashed var(--md-sys-color-outline)!important;border-radius:28px!important;background:transparent!important;min-height:180px}.dash-footer{text-align:center;padding:28px}
@media(max-width:900px){.orbit-top{left:12px;right:12px;top:10px;height:64px}.orbit-wordmark small,.orbit-online span{display:none}#open-sb{display:grid}.sidebar{left:12px!important;width:min(320px,calc(100vw - 24px))!important;transform:translateX(calc(-100% - 30px))!important}.sidebar.open{transform:none!important}.sb-close{display:grid!important;width:44px!important;height:44px!important}.main{padding:94px 16px 56px!important}.orbit-flow,.orbit-insights,.orbit-trust{grid-template-columns:1fr}.orbit-pulse{grid-template-columns:repeat(3,1fr)}.orbit-pulse>div:first-child{grid-column:auto}.psiphon-status-head{grid-template-columns:1fr}.psi-grid{grid-template-columns:repeat(2,1fr)}.cp-body{grid-template-columns:1fr!important}.create-panel .cp-block,.create-panel .cp-body>.cp-block:nth-of-type(n+3),.create-panel .endpoint-studio,.create-panel .config-proxy-studio,.create-panel .cp-footer{grid-column:1!important}.route-card{display:block!important}.route-actions{grid-column:auto!important;grid-row:auto!important;border-inline-start:0!important}}
...
function psiphonDuration(seconds){
  const n=Number(seconds);
  if(!Number.isFinite(n)||n<0)return '—';
  const minutes=Math.floor(n/60),rest=Math.floor(n%60);
  return minutes?`${minutes}m ${rest}s`:`${rest}s`;
}
function renderPsiphonStatus(data){const s=document.getElementById('psiphon-status-state'),g=document.getElementById('psiphon-status-grid'),n=document.getElementById('psiphon-status-note');if(!s||!g)return;const state=String(data?.state||'UNAVAILABLE').toUpperCase(),off=!data?.enabled||state==='DISABLED',issue=String(data?.last_error||''),meta={AVAILABLE:['ti-circle-check','Tunnel available'],ACTIVE:['ti-circle-check','Tunnel active'],DISABLED:['ti-player-pause','Intentionally disabled'],UNAVAILABLE:['ti-plug-off','Core unavailable'],DEGRADED:['ti-alert-triangle','Reduced capability'],STARTING:['ti-loader','Starting tunnel'],RECONNECTING:['ti-refresh','Reconnecting'],UNKNOWN:['ti-help','State unknown'],FAILED:['ti-circle-x','Tunnel failed']}[state]||['ti-help',state];s.className='psiphon-status-state state-'+state.toLowerCase();s.innerHTML=`<i class="ti ${meta[0]}"></i><span>${esc(tr(meta[1]))}</span><small>${esc(state)}</small>`;const msg=off?'Disabled by PSIPHON_ENABLED. No Core process or worker is running.':issue?issue+'. Primary VLESS/WebSocket traffic is unaffected.':'The isolated Core proxy is loopback-only. The primary route remains independent.';n.className='psiphon-status-note '+(issue?'has-issue':'');n.innerHTML=`<i class="ti ${issue?'ti-alert-hexagon':'ti-shield-check'}"></i><div><b>${esc(tr(issue?'Operational issue':'Primary route protected'))}</b><span>${esc(msg)}</span></div>`;const c=(l,v)=>`<div class="psiphon-status-cell"><span>${esc(tr(l))}</span><strong>${esc(v??'—')}</strong></div>`;g.innerHTML=`<details class="psi-details"><summary>${esc(tr('Live session details'))} <i class="ti ti-chevron-down"></i></summary><div class="psi-grid">${[c('Psiphon WS',data?.psiphon_ws_status),c('Core availability',data?.core_available?'Configured':'Unavailable'),c('Selected location',data?.selected_location),c('Tunnel setup',data?.tunnel_setup_ms==null?'—':proxyMs(data.tunnel_setup_ms)),c('Session age',psiphonDuration(data?.session_age_seconds)),c('Remaining lifetime',psiphonDuration(data?.remaining_lifetime_seconds)),c('Next rotation',data?.next_rotation_at),c('Rotation count',String(data?.rotation_count??0)),c('TCP tunnel health',data?.tcp_tunnel_health),c('UDP tunnel health',data?.udp_tunnel_health),c('Exit IP',data?.exit_ip),c('Exit region',data?.exit_region||data?.exit_country)].join('')}</div></details>`}
async function loadPsiphonStatus(){
  try{
    const r=await authF('/api/psiphon/status',{cache:'no-store'},{retries:0,timeoutMs:8000});
    const data=await r.json().catch(()=>({}));
    if(!r.ok)throw new Error('Psiphon status unavailable');
    renderPsiphonStatus(data);
  }catch(_error){
    renderPsiphonStatus({enabled:false,state:'UNAVAILABLE',tcp_tunnel_health:'UNKNOWN',udp_tunnel_health:'NOT_SUPPORTED'});
  }
}
